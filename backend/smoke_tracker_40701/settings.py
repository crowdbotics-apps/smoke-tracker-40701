"""
Django settings for smoke_tracker_40701 project.
...
ROOT_URLCONF = 'smoke_tracker_40701.urls'
...
WSGI_APPLICATION = 'smoke_tracker_40701.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "smoke_tracker_40701 API",
    "DESCRIPTION": "API documentation for smoke_tracker_40701 App",
    "VERSION": "v1",
}
